      ...
      <div className="mx-auto max-w-5xl px-5 py-10 sm:px-6 md:py-14 lg:px-8">
        <section className="grid gap-px bg-white/10 md:grid-cols-3">
          {[
            [
              Swords,
              "比较解法",
              "用正确性、考场性、结构美感、计算量与讲解友好度建立共同坐标。",
            ],
            [
              BookOpenCheck,
              "学习思路",
              "保留观察入口、思路来源与关键转化，让“怎么想到”可以被复盘。",
            ],
            [
              GitBranch,
              "沉淀题解",
              "通过公开投稿、校订和验证，逐步形成可引用、可改进的高质量内容。",
            ],
        ...
        <section className="mt-6 border border-amber-400/25 bg-amber-400/5 p-6 md:p-8">
          ...
          <p className="mt-3 text-sm leading-7 text-zinc-400">
            当前为 ProofArena
            Demo，题目与解法数据仍在整理中。现阶段重点是验证阅读路径、评分体系、交互图像和投稿规范，而不是追求题目数量。
          </p>
        </section>
        ...
        <section className="mt-6 border border-white/10 bg-zinc-950">
          ...
          <div className="grid gap-px bg-white/10 sm:grid-cols-2">
            <div className="bg-zinc-950 p-6">
              ...
              <span className="mt-5 block font-mono text-xs uppercase text-zinc-500">
                代码
              </span>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link
            href="/problems"
            className="inline-flex h-11 items-center bg-cyan-400 px-4 text-sm font-bold text-zinc-950"
          >
            查看题目擂台
          </Link>
          <Link
            href="/submit"
            className="inline-flex h-11 items-center border border-white/20 px-4 text-sm font-bold text-white"
          >
            提交你的解法
          </Link>
        </div>
