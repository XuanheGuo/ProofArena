...
import { Button, SectionPanel, Panel } from "@/components/ui";
import {
  canRequestContestRegistration,
  computeContestSubmitAccess,
  ...
  if (user === null) {
    ...
    return (
      <SectionPanel className="p-5">
        ...
        <Panel
          tone="subtle"
          className="mt-4 flex items-center gap-3 border-amber-400/20 bg-amber-400/[0.04] px-4 py-3"
        >
  ...
  return (
    <SectionPanel className="p-5">
      ...
      {isApproved ? (
        <Panel
          tone="subtle"
          className="mt-4 flex items-center gap-3 border-emerald-500/30 bg-emerald-500/[0.05] px-4 py-3"
        >
        ...
        <Panel
          tone="subtle"
          className="mt-4 flex items-center gap-3 border-amber-400/30 bg-amber-400/[0.05] px-4 py-3"
        >
        ...
        <Panel
          tone="subtle"
          className="mt-4 flex items-center gap-3 border-red-500/30 bg-red-500/[0.05] px-4 py-3"
        >
      ...
      {canRequest && (
        <div className="mt-4">
          ...
          {requestError && (
            <p className="mt-2 text-xs text-red-300">{requestError}</p>
          )}
        </div>
      )}
    </SectionPanel>
