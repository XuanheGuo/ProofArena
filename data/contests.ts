...
export const contests: Contest[] = [
  ...
  },
  {
    ...
    tagline: "一周赛制：普通题稳定作答、挑战题前期博弈、计时题速答对决、解答题深度较量。",
    description: "8 天 / 每天 2 道普通题 + 3 道计时题 / 2 道挑战题 / 1 道解答题 / 赛后讨论与申诉",
    ...
    rules: [
      ...
      "解答题 Day 3 公布，Day 5 或 Day 6 截止，允许 partial credit，不吃挑战倍率。",
