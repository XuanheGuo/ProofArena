...
export const tagKnowledgeMap: Record<string, string[]> = {
  ...
  函数图像: ["k-function-intersection-count", "k-derivative-zero"],
  函数零点: ["k-function-intersection-count", "k-derivative-zero"],
  对数函数: ["k-log-inequality", "k-function-intersection-count"],
  方程根数: ["k-function-intersection-count", "k-derivative-zero"],
  有理函数: ["k-function-intersection-count"],
  多项式: ["k-function-intersection-count"],
  ...
  随机排列: ["k-random-permutation-stopping", "k-probability-modeling"],
  对称性: ["k-counting-combinatorics"],
  负超几何: ["k-random-permutation-stopping"],
  组合计数: ["k-counting-combinatorics"],
  分类讨论: ["k-counting-combinatorics"],
  互素: ["k-conflict-graph-counting", "k-counting-combinatorics"],
  图模型: ["k-conflict-graph-counting", "k-cycle-permutation-graph"],
  环排列: ["k-cycle-permutation-graph"],
  Hamilton回路: ["k-cycle-permutation-graph"],
  "Hamilton 回路": ["k-cycle-permutation-graph"],
  欧拉公式: ["k-conflict-graph-counting"],
...
export const tagInsightMap: Record<string, string[]> = {
  ...
  函数图像: ["i-intersection-count-graph"],
  函数零点: ["i-intersection-count-graph", "i-double-root-graph"],
  对数函数: ["i-log-touch-tangent", "i-intersection-count-graph"],
  方程根数: ["i-intersection-count-graph"],
  有理函数: ["i-intersection-count-graph"],
  多项式: ["i-intersection-count-graph"],
  ...
  随机排列: ["i-last-position-stopping"],
  对称性: ["i-last-position-stopping"],
  负超几何: ["i-last-position-stopping"],
  组合计数: ["i-conflict-graph-complement"],
  分类讨论: ["i-conflict-graph-complement"],
  互素: ["i-conflict-graph-complement"],
  图模型: ["i-conflict-graph-complement", "i-cycle-as-hamilton"],
  环排列: ["i-cycle-as-hamilton"],
  Hamilton回路: ["i-cycle-as-hamilton"],
  "Hamilton 回路": ["i-cycle-as-hamilton"],
